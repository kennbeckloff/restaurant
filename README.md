...
****
## Project Description
A simple web application that allows users to give review on restaurants they have visited. Users are able to view other application users reviews. A user can be able to add a restaurant Reviews, by uploading the image of the restaurant, title and a short description about the restaurant.
******
## Functions
1.login/signup
2.Add restaurant and review
3.View available Restaurant Reviews
...
## Screenshots
### LOG IN
 ![login](https://user-images.githubusercontent.com/36301800/195834737-f79c1796-dbbf-493a-86a2-db89f528c9cf.png)
 ### SIGN UP
 ![Screenshot from 2022-10-14 14-21-36](https://user-images.githubusercontent.com/36301800/195835207-0ae7f0de-1cbc-409e-b76d-d299fe8886ca.png)
